...
-- Kill Script Button
local killBtn, yS2 = createFlatButton(settingsScroll, "🛑 KILL SCRIPT", yS, Color3.fromRGB(255, 50, 50), Color3.fromRGB(200, 50, 50), function()
...
-- Hide UI Button
local hideBtn, yS4 = createFlatButton(settingsScroll, "Hide UI", yS, BUTTON_BG, BUTTON_BORDER, hideGUI)
yS = yS4
...
settingsScroll.CanvasSize = UDim2.new(0, 0, 0, yS + 20) 
